...
// Fetch all orders with payment mode
$get_orders = "SELECT uo.*, up.payment_mode 
                FROM `user_orders` uo 
        ...
        <tbody class='text-center'>
            ...
            if ($row_count == 0) {
                ...
                while ($row_data = mysqli_fetch_array($result)) {
                    ...
                    $payment_mode = $row_data['payment_mode']; // Payment Mode
                    $token_viewed = $row_data['token_viewed']; 
                    $number++;
            ?>
                    <tr>
