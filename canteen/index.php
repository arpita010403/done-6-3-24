...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse  " id="navbarSupportedContent">
      ...
      <li class="nav-item ">
          <a class="nav-link text-light" aria-current="page" href="./admin/ad_login.php"><i class="fa fa-user-circle" aria-hidden="true">Admin</i></a>
        </li>
...
<section class="banner-section">
  <div class="container" style="color:white;">
   <br><br>
      <h1 class="text-center">Online Canteen</h1>
...
<section>
  <h2 class="text-center">Our Services</h2>
    ...
    <div class="services-container">
        <div class="service">
            <img src="./images/good.jpg" alt="good_food">
            <div class="service-content">
                <h3>Fresh and Good Quality</h3>
                <p>Commitment to providing high-quality, fresh, and hygienic food items..</p>
            </div>
        </div>
        
        <div class="service">
            <img src="./images/customise.jpg" alt="Customization">
            <div class="service-content">
                <h3>Customization</h3>
                <p>Ability for customers to customize their orders based on dietary preferences or special requests.</p>
            </div>
        </div>
        <div class="service">
            <img src="./images/service.jpg" alt="contact">
            <div class="service-content">
                <h3>Customer Support</h3>
                <p>Responsive customer support team to address any queries or concerns promptly.</p>
            </div>
        </div>
...
<div class="container">
<h2 class="text-center"><a href="display_all.php" style="color:white">Menu </a> </h2>
<!--fifth child-->
<div class="row">
    <div>
        <!--products-->
